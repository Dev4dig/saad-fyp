...
<script>
    ...
    <div class="single-img-wrapper">
                ...
                <div class="img-header">
                    <button id="img-menu-button{{$i}}" class="btn btn-xs  img-opt-btn font-icon icon-menu" style="float: right;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-three-dots" viewBox="0 0 16 16">
